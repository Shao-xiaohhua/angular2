...
@Component({
    selector: 'widget-talktemp',
    templateUrl: './talktemp.component.html',
    styleUrls: ['./../../../../node_modules/select2/dist/css/select2.min.css'],
    encapsulation: ViewEncapsulation.None
})
export class TalktempComponent implements AfterViewInit {
    private select2: any;
    public options = [];
    ...
    initOptions() {
        ...
        const params = { caseTypeId: caseTypeId, docType : '1f35d9266f064cdc920c93a4659197ee'};
