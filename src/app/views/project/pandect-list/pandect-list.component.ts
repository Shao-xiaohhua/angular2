...
@Component({
  selector: 'app-pandect-list',
  templateUrl: './pandect-list.component.html',
  styleUrls: ['./pandect-list.component.scss'],
  providers: [MachineService]
})
export class PandectListComponent implements OnInit {
